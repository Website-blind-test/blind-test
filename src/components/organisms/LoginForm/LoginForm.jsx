...
export const LoginForm = () => {
    return (
        <div id="loginForm">
            <form >
                <LabeledField label={{children:"Identifiant :"}} id="login" type="text" sx={{borderRadius: 2, bgcolor: 'background.paper', position: 'relative', bottom: '0.5rem'}}></LabeledField>
                <LabeledField label={{children:"Mot de passe :"}} id="pwd" type="password" sx={{borderRadius: 2, bgcolor: 'background.paper', position: 'relative', bottom: '0.5rem'}}></LabeledField>
